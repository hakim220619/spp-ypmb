...
import TableHeader from 'src/pages/ms/permission/TableHeader'
import { useRouter } from 'next/router'
import toast from 'react-hot-toast'
import { deletePermission, fetchDataPermission } from 'src/store/apps/permission'
...
const PermissionList = () => {
  ...
  useEffect(() => {
    setLoading(true)
    dispatch(fetchDataPermission({ school_id, q: value })).finally(() => {
      setLoading(false)
    })
