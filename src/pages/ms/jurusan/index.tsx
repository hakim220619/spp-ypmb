...
import { fetchDataJurusan, deleteJurusan } from 'src/store/apps/jurusan/index'
...
const RowOptions = ({ uid }: { uid: any }) => {
  ...
  const handleDelete = async () => {
    try {
      await dispatch(deleteJurusan(uid)).unwrap()
      await dispatch(fetchDataJurusan({ school_id, major_status: '', q: value }))
...
const JurusanList = () => {
  ...
  const dispatch = useDispatch<AppDispatch>()
  const store = useSelector((state: RootState) => state.Jurusan)
